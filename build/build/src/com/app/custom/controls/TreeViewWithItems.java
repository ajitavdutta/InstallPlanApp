package com.app.custom.controls;
...
public class TreeViewWithItems<T extends HierarchyData<T>> extends TreeView<T> {
	...
	/**
	 * Also store a reference from each tree item to its weak listeners, so that
	 * the listener can be removed, when the tree item gets removed.
	 */
	...
	/**
	 * Gets a {@link javafx.collections.ListChangeListener} for a
	 * {@link TreeItem}. It listens to changes on the underlying list and
	 * updates the UI accordingly.
	 *
	 * @param treeItemChildren
	 *            The associated tree item's children list.
	 * @return The listener.
	 */
