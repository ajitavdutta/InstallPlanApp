...
public class FillTemplateHelper extends PdfPageEventHelper {
	...
	public void onEndPage(PdfWriter writer, Document document) {
		...
		try {
			...
			ct.addText(new Chunk("page " + writer.getPageNumber(), new Font(basefont, 5)));
			...
			ct.setLeading(9);
			ct.addElement(new Paragraph(String.format(sender, today), new Font(basefont, 5)));
			ct.go();
	...
	public void onCloseDocument(PdfWriter writer, Document document) {
		// we only know the total number of pages at the moment the document is
		// closed.
		String s = " of " + (writer.getPageNumber());
		Phrase p = new Phrase(12, s, new Font(basefont, 5));
